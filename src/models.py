...
class admin(baseClass):
    ...
    @classmethod
    def getFields(cls):
        return [("politicalAppearance","政治面貌"),("professionalTitle","职称")]
...
class teacher_admin(teacher,admin):
    ...
    @classmethod
    def getFields(cls):
        return [("department","所在系部"),("major","专业"),("professionalTitle","职称"),("politicalAppearance","政治面貌")]

    @classmethod
    def from_dict(cls,d:dict):
        return cls(d['personID'],d['personName'],d['personGender'],d['personAge'],
                   d.get('department',''),d['major'],d['professionalTitle'],d['politicalAppearance'])
    ...
    def __repr__(self):
        return f"teacher_admin(personID={self._personID}, personName={self._personName}, personGender={self._personGender}, personAge={self._personAge}, department={self._department}, major={self._major}, professionalTitle={self._professionalTitle}, politicalAppearance={self._politicalAppearance})"

    def __str__(self):
        return f"{self._personName}({self._personID})，{self._personGender}，{self._personAge}岁，{self._department}，{self._major}，{self._professionalTitle}，{self._politicalAppearance}"
